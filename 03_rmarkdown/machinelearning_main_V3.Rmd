...
gg.age.charges <- ggplot(data = insurance,
                  mapping = aes (y = age,
                                 x = charges)) +
  geom_point()
gg.age.charges + geom_smooth() + ggtitle("charges depending on age")
```
...
gg.age.charges + 
  geom_smooth(method = "lm", 
              ...
              ggtitle("charges depending on age with quadratic term")
```
...
ggplot(data = insurance,
  ...
  facet_wrap(. ~ sex) + ggtitle("charges depending on gender")
```
...
gg.age.charges.part2 <- ggplot(data = insurance.part2,
                              mapping = aes (y = age,
                                             x = charges)) +
  geom_point()
gg.age.charges.part2 + geom_smooth() + ggtitle("over 18'000 charges depending on age")
```
...
In terms of 
As decision trees do not work with an R-squared value per se, we take the residual mean deviance for the decision trees (here at 0.1592). The residual mean deviance can be considered as R-squared error. 
