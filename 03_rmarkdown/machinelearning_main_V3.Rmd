...
It appears that the high misclassication rate is partly due to only 2 of the 4 factors being applied in the classification tree. We thus go into testing mode:
...
We here receive a root mean squared error of 0.391 --> root mean error = 0.152881.
