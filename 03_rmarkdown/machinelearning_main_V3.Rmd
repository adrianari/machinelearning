...
insurance.test <- insurance[!train.YES, ]
  ...
  r.squared.lm.insurance.3[i] <- cor(lm.insurance.3.predict, 
                           insurance.test$charges)^2
  
  r.squared.lm.insurance.all[i] <- cor(lm.insurance.all.predict, 
                           insurance.test$charges)^2
  
  r.squared.tree.regression.charges[i] <- cor(tree.regression.charges.predict, 
                           insurance.test$charges)^2
  
  r.squared.rf.insurance[i] <- cor(rf.insurance.predict, 
                           insurance.test$charges)^2
