...
```
As the output shows the additionally added variable of sex with a calculated p-value of 0.0149 seems to have an effect on charges and therefore should be considerd within the modeling process.
...
```
For the comparisonm we used R-Squared and the adjusted R-Squared to measure the performance of our models.
