...
for(i in 1:10){
  ...
  #insurance.train.normalized <- cbind(insurance.train$smoker, insurance.train$charges, insurance.train$age, insurance.train$bmi)
  
    #insurance.test.normalized <- cbind(insurance.test$smoker, insurance.test$charges, insurance.test$age, insurance.test$bmi)
