...
```{r}
plot(charges ~ sex, data =insurance, xlab = "male = 0 / female = 1",  main = 'Charges against sex') 
```
...
```{r}
plot(charges ~ smoker, data =insurance, xlab = "nonsmoker = 0 / smoker = 1, ", main = 'Charges against smoker')
```
...
(tree.classification.region.pred.error2 <- 1 - tree.classification.region.pred.rate) 
```
...
## Cross-Validation for continuous variable


We also cross-validate the classiciafication tree. We recall, the misclassification error on the entire data set was at, whereas for the train <-> test dataset it was 
