...
Please note that hence, all charges values for this chaptre will strictly be indicated in log-value and not the true one.
...
We now do a prediction with the booted model.
