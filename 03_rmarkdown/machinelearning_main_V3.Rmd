...
By working with the test data, we already can see at this point a change, meaning the overfit of working with our entire dataset. Were there previously six end nodes, we now have seven end notes, with variables used "charges", "smoker", "region" and "age", as also can be seen here:
...
Interesstingly, we receive a RSS for the train dataset of 30.23 whereas for the test set, the RSS is 28.17. 
...
Thanks to the prune.misclass function, we do not have to worry about cost complexity pruning ourselves but can simply apply the function as can be seen below:
