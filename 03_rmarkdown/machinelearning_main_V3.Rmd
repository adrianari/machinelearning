...
Our modell seems not to be perfoming that good. For reference, in the summary of the data for the BMI, the mean was at around 30. Here, we work with a mean squared error of 29.
...
By working with the test data, we already can see at this point the importance of doing so. Whereas previously, only charges were thought to be of importance to determine the BMI, it now also shows, that age seems to play a role. 
