...
What is interesting to see, is that the lm modell with all the variables and the regression tree perform very similarly. 
...
We see here that with 66.99%, our misclassification error has not much improved with crossvalidation. In fact, it even has gotten a bit worse.
