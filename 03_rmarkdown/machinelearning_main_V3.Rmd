...
plot(tree.regression.bmi.pruning)
```
...
We here see that the tree with seven end nodes has the smallest cross-validation error of about 27'500.

```{r}
par(mfrow=c(1,2))
plot(tree.regression.bmi.pruning$size, tree.regression.bmi.pruning$dev, type="b")
plot(tree.regression.bmi.pruning$k, tree.regression.bmi.pruning$dev, type="b")
par(mfrow=c(1,1))
```

```{r}
tree.regression.bmi.pruned <- prune.tree(tree.regression.bmi2, best = 4)
